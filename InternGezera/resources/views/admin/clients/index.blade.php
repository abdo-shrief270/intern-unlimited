            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ URL::current() }}">Affiliates</a></li>
                    </ol>
                </nav>
            </div>

            <div class="seperator-header layout-top-spacing">
                <a class="btn btn-outline-primary" href="{{route('admin.client.create')}}">Create New Client</a>
            </div>
